...
def train_detector(
    ...
    torch.save(detector.state_dict(), "fcos_detector5.pt")
...
def inference_with_detector(
    ...
    for iter_num, test_batch in enumerate(test_loader):
        ...
        # print(image_path)
        # image_path = "../data/VOCdevkit/VOC2007/JPEGImages/009959.jpg"
        #print(image_path)
        ...
        if output_dir is not None:
            ...
            # image_array = np.transpose(image, (1, 2, 0))  # Transpose the array to (480, 640, 3)
    ...
    if output_dir is None:
        writer=SummaryWriter("detection_logs")
        image_grid = make_grid(all_images, nrow=1)
